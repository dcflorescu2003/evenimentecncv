...
import { Headset, CalendarDays, Users2, LogOut } from "lucide-react";
import { ModuleSwitcher } from "@/components/ModuleSwitcher";

export default function SmartLabLayout() {
  ...
  const navItems = [
    { title: "Rezervări", icon: CalendarDays, path: "/smartlab" },
    ...(isAdmin ? [{ title: "Voluntari", icon: Users2, path: "/smartlab/volunteers" }] : []),
  ];
