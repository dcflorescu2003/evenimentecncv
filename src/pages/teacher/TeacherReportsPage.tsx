        ...
        <CardContent className="p-0">
          <div className="overflow-auto">
            <Table>
              ...
              <TableBody>
                {isLoading ? (
                  <TableRow><TableCell colSpan={99} className="text-center">Se încarcă...</TableCell></TableRow>
                ) : !data?.students?.length ? (
                  <TableRow><TableCell colSpan={99} className="text-center text-muted-foreground">Nu există date.</TableCell></TableRow>
